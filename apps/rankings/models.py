...
class GroupRanking(models.Model):
    ...
    group = models.ForeignKey(
        Group, on_delete=models.CASCADE, related_name="rankings_to_complete"
    )
...
class UserRanking(models.Model):
    ...
    group_ranking = models.ForeignKey(
        GroupRanking, on_delete=models.CASCADE, related_name="submissions"
    )
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="group_submissions"
    )
...
class RankedTrack(models.Model):
    ...
    user_ranking = models.ForeignKey(
        UserRanking, on_delete=models.CASCADE, related_name="ranked_tracks"
    )
